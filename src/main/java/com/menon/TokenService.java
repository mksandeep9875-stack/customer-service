...
public class TokenService
{
    ...
    public boolean validateToken(String token)
    {
        ...
        log.info("Calling customer-service to validate token: " + token);
        ...
        log.info("Response from customer-service: " + authResponse);
        ...
        {
            log.info("Error in customer-service: " + authResponse);
            throw new RuntimeException("Error in customer-service: " + authResponse);
        }
